...
CFLAGS  += -Wall -c -mcpu=arm926ej-s -O2 -I. -I./include -DIPED_98 -I./akmedialib/include/ -I./akmedialib/include/akmedialib
LDFLAGS += -L./alsa/lib/ -L./lib -lpthread -lasound -ludt -lstdc++ -lstun -lm -lspeexdsp \
...
OBJ += lib/libstun.a libstdc++.a lib/libspeexdsp.a lib/AMR_NB_ENC.a lib/libudt.a \
